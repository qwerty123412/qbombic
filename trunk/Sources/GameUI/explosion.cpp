                     ...
                     QList<Bomb*> *bombs) : Bomb(bomb, pos_x, pos_y, ttl)
{
    ...
    if(direction == 0) {
        if((*level_data)[ floor(pos_x/tile_size) + level_width * floor((pos_y - tile_size)/tile_size) ] < 2)
        ...
        if((*level_data)[ floor( (pos_x + tile_size)/tile_size) + level_width * floor((pos_y)/tile_size) ] < 2)
            explosions.push_back(new Explosion(new AnimatedPixmapItem(*bomb),
                                   pos_x + tile_size,
                                   pos_y,
                                   explosions,
